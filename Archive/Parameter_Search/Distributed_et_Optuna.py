...
#study = optuna.create_study(direction="maximize", storage='sqlite:///../../data/example.db')
study = optuna.create_study(direction="maximize", storage="mysql://root@localhost/example")
# study.optimize(objective, n_trials=100, load_if_exists=True)
